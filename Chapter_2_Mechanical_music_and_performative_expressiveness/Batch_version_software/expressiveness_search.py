...
def expressiveness_search():
    ...
    print("\nTotal number of events: " + str(len(df_creation.pd_df_notes_list)))
    print("Total number of not analyzed events: " + str(len(df_creation.pd_df_notes_list) - len(df_creation.pd_df_notes_list_cleaned)))
    print("Mean of normalized distance score: " + str(round(np.sum(np_norm_distance_score)/len(np_norm_distance_score))) + "\n")
